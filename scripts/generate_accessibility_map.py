...
<div class="panel">
  ...
  <div class="sub">Edmonton homes with accessibility-related building permits
    &mdash; ramps, lifts, wheelchair access, barrier-free features. Click any dot
    for details and a Street View photo.</div>
  <details class="about">
    <summary>About &amp; data source</summary>
    <div class="body">Built for <b>Spinal Cord Injury Alberta</b> from the City of
      Edmonton's public building &amp; development permit records (2009&ndash;present).
      This is an automatically generated draft, so some entries may be false
      matches (for example, a parking-garage &ldquo;ramp&rdquo;) &mdash; check the
      permit description in each popup. Not an official listing.</div>
  </details>
  <div id="count"></div>
